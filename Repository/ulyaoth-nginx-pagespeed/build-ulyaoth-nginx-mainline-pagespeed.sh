...
su ulyaoth -c "wget https://github.com/pagespeed/ngx_pagespeed/archive/release-1.9.32.4-beta.zip"
su ulyaoth -c "wget https://dl.google.com/dl/page-speed/psol/1.9.32.4.tar.gz"
su ulyaoth -c "unzip release-1.9.32.4-beta.zip"
su ulyaoth -c "tar xvf 1.9.32.4.tar.gz"
su ulyaoth -c "cp -rf ngx_pagespeed-release-1.9.32.4-beta/* /etc/nginx/modules/pagespeed/"
...
su ulyaoth -c "rm -rf 1.9.32.4.tar.gz ngx_pagespeed-release-1.9.32.4-beta release-1.9.32.4-beta.zip"
...
su ulyaoth -c "wget http://nginx.org/download/nginx-1.9.2.tar.gz"
