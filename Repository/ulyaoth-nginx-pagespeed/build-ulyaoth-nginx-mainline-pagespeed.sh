...
su ulyaoth -c "cp -rf ngx_pagespeed-release-1.9.32.6-beta/* /etc/nginx/modules/pagespeed/"
...
su ulyaoth -c "rm -rf 1.9.32.6.tar.gz ngx_pagespeed-release-1.9.32.6-beta release-1.9.32.6-beta.zip"
