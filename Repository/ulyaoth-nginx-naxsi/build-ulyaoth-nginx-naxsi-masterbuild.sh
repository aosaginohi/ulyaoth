...
then
su ulyaoth -c "wget https://raw.githubusercontent.com/sbagmeijer/ulyaoth/master/Repository/ulyaoth-nginx-naxsi/SPECS/ulyaoth-nginx-naxsi-masterbuild.spec-mageia -O ulyaoth-nginx-naxsi-masterbuild.spec"
else
...
then
urpmi --auto --buildrequires /home/ulyaoth/rpmbuild/SPECS/ulyaoth-nginx-naxsi-masterbuild.spec
else
