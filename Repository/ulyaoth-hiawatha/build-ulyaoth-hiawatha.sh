...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/Fedora/x86_64/ulyaoth-1.0.6-1.fc19.x86_64.rpm
  fi
...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/Fedora/x86_64/ulyaoth-1.0.6-1.fc20.x86_64.rpm
  fi
...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/Fedora/x86_64/ulyaoth-1.0.6-1.fc21.x86_64.rpm
  fi
...
then
  ...
  then
    ...
    dnf install -y https://downloads.ulyaoth.net/rpm/Fedora/x86_64/ulyaoth-1.0.6-1.fc22.x86_64.rpm
  fi
...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/rhel/x86_64/ulyaoth-1.0.6-1.el6.x86_64.rpm
  fi  
...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/CentOS/x86_64/ulyaoth-1.0.6-1.el6.x86_64.rpm
  fi
...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/OracleLinux/x86_64/ulyaoth-1.0.6-1.el6.x86_64.rpm
  fi
...
then
  ...
  then
    ...
    yum install -y https://downloads.ulyaoth.net/rpm/scientific/x86_64/ulyaoth-1.0.6-1.el6.x86_64.rpm
  fi
