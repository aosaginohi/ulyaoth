...
su ulyaoth -c "git clone -b HHVM-3.3 git://github.com/facebook/hhvm.git"
mv /home/ulyaoth/hhvm /home/ulyaoth/hhvm-3.3.0
cd /home/ulyaoth/hhvm-3.3.0
su ulyaoth -c "git submodule update --init --recursive"
cd /home/ulyaoth
su ulyaoth -c "tar cvf hhvm-3.3.0.tar.gz hhvm-3.3.0/"
mv /home/ulyaoth/hhvm-3.3.0.tar.gz /home/ulyaoth/rpmbuild/SOURCES/
rm -rf /home/ulyaoth/hhvm-3.3.0
